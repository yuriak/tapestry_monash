...
SLAKSHNA_PLAYIT_ROOT="${SLAKSHNA_PLAYIT_ROOT:-${SLAKSHNA_TOOL_ROOT}/playit}"
SLAKSHNA_PLAYIT_BIN="${SLAKSHNA_PLAYIT_BIN:-${SLAKSHNA_PLAYIT_ROOT}/bin/playit}"
SLAKSHNA_PLAYIT_DAEMON="${SLAKSHNA_PLAYIT_DAEMON:-${SLAKSHNA_PLAYIT_ROOT}/bin/playitd}"
...
export SLAKSHNA_PLAYIT_ROOT SLAKSHNA_PLAYIT_BIN SLAKSHNA_PLAYIT_DAEMON
...
phase0_print_layout() {
    ...
    echo "  playit CLI  : ${SLAKSHNA_PLAYIT_BIN}"
}
