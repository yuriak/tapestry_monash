...
exec "${python_bin}" \
    "${repo_root}/monash_exps/src/m0/evaluate_global_opinion_qa_vllm.py" \
    ...
    --output-dir "${M0_EVAL_OUTPUT_DIR:-${runtime_root}/evaluation/global-opinion-qa-final-${timestamp}}" \
