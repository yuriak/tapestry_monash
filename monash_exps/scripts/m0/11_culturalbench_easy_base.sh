...
output_dir="${M0_EVAL_OUTPUT_DIR:-${runtime_root}/evaluation/culturalbench-easy-base-${timestamp}}"
...
exec "${python_bin}" "${repo_root}/monash_exps/src/m0/evaluate_culturalbench_vllm.py" \
    ...
    --dataset "${repo_root}/monash_exps/.runtime/data/m0/benchmarks/raw/CulturalBench/CulturalBench-Easy.csv" \
